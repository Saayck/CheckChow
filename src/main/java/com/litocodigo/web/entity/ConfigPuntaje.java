...
public class ConfigPuntaje {
    ...
    @Column(name = "puntaje_correcto", precision = 8, scale = 4, nullable = false) private java.math.BigDecimal puntajeCorrecto = new BigDecimal("20.0000");
    @Column(name = "puntaje_incorrecto", precision = 8, scale = 4, nullable = false) private java.math.BigDecimal puntajeIncorrecto = new BigDecimal("-1.8750");
    @Column(name = "puntaje_blanco", precision = 8, scale = 4, nullable = false) private java.math.BigDecimal puntajeBlanco = BigDecimal.ZERO;
    @Column(name = "puntaje_anulado", precision = 8, scale = 4, nullable = false) private java.math.BigDecimal puntajeAnulado = BigDecimal.ZERO;
    @Column(name = "puntaje_base", precision = 8, scale = 4, nullable = false) private java.math.BigDecimal puntajeBase = BigDecimal.ZERO;
